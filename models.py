...
def define_D(input_nc, ndf, netD, n_layers_D=3, norm='batch', init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    if netD == 'basic':
        ...
        net = PixelDiscriminator(input_nc=input_nc, ndf=ndf,norm_layer=norm_layer)
    else:
...
if __name__ == '__main__':
    ...
    output = torch.rand(1, 6, 512, 512).cuda()
    # net = define_G(
    #     input_nc=3,
    #     output_nc=3,
    #     ngf=64,
    ...
    netD = define_D(input_nc=6, ndf=64, netD='basic').cuda()
    # net = define_G(
    #     input_nc=3,
    #     output_nc=3,
    #     ngf=64,
