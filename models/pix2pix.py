...
class Pix2PixModel(BaseModel):
    ...
    def forward(self):
        self.fake_B = self.netG(self.realA)
    
    def backward_D(self):
        fake_AB = torch.cat((self.realA, self.fake_B), dim=1)
    ...
    def backward_G(self):
        ...
        self.loss_G_L1 = self.criterionL1(self.fake_B, self.realB) * self.opt.lambda_l1
